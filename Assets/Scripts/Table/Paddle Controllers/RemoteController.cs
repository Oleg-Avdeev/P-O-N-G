...
{
    public class RemoteController : IPaddleController
    {
        private bool _isBottomPlayer;
        private Camera _projectionCamera;
        private float _lastValue = 0;

        public RemoteController(bool isBottomPlayer, Camera camera)
        {
            _isBottomPlayer = isBottomPlayer;
            _projectionCamera = camera;
        }

        bool IPaddleController.CanPlay(bool isLocalUser) => isLocalUser;
